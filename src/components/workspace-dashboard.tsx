...
const loadQuestionBankTab = () => import("@/components/tabs/question-bank-tab");
const loadTeacherTrainingTab = () => import("@/components/tabs/teacher-training-tab");
...
const QuestionBankTab = dynamic(loadQuestionBankTab, {
  loading: () => <TabSkeleton variant="workspace" />,
});
const TeacherTrainingTab = dynamic(loadTeacherTrainingTab, {
  loading: () => <TabSkeleton variant="workspace" />,
});
...
const preloadWorkspaceTabComponents: Record<TabKey, () => Promise<unknown>> = {
  ...
  questionBank: loadQuestionBankTab,
  teacherTraining: loadTeacherTrainingTab,
...
function WorkspaceDashboardContent() {
  ...
  const tabContent = (
    <>
      ...
      {safeActiveTab === "questionBank" && <QuestionBankTab />}
      {safeActiveTab === "teacherTraining" && <TeacherTrainingTab />}
