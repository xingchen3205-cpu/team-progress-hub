...
const actionMeta: Record<string, { label: string; module: string; tone: "info" | "success" | "warning" }> = {
  ...
  "review_screen_session.random_drawn": { label: "随机抽签生成顺序", module: "路演大屏", tone: "warning" },
  "review_screen_session.order_updated": { label: "手动调整路演顺序", module: "路演大屏", tone: "warning" },
  "review_screen_session.self_draw_candidate_selected": { label: "抽取上台项目", module: "路演大屏", tone: "info" },
  "review_screen_session.self_drawn": { label: "项目自助抽签", module: "路演大屏", tone: "info" },
